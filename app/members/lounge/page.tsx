...
const ROOMS = [
  { slug: "weekly", title: "broT Meeting", subtitle: "Primary room • steady cadence" },
      ...
      <div className="wrap">
        <div className="flex items-center justify-between gap-3">
          ...
          <div className="flex gap-2">
            ...
            <Link href="/members/room/weekly" className="btn btnPrimary">broT Meeting</Link>
          </div>
        </div>
        ...
        <div className="glass rounded-3xl p-6 mt-5">
          ...
          <div className="text-sm text-white/65 mt-2">
            Click a room → opens the branded embed page. No extra clicks.
          </div>
